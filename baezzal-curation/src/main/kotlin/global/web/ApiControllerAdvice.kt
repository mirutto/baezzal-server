...
class ApiControllerAdvice {
    ...
    fun handleBindException(): ResponseEntity<ErrorResponse> {
    ...
    fun handleNotReadable(): ResponseEntity<ErrorResponse> {
        return badRequest("요청 본문(JSON)이 올바르지 않습니다")
    }

    @ExceptionHandler(MissingServletRequestParameterException::class)
    fun handleMissingValue(): ResponseEntity<ErrorResponse> {
